-- Active: 1790122657707@@127.0.0.1@5432@bd_hortifruit@public

CREATE DATABASE bd_hortifruit;
...
/*
Os conceitos dos termos estão comentados no decorrer do código, mas explicando a atividade prática no geral eu 
criei uma tabela chamada itens_venda para organizar os dados das vendas de um hortifrúti. 
Nela, coloquei informações como o número da venda, data, produto, categoria, unidade, quantidade, valor unitário 
e bairro de entrega.

Primeiro, preparei a tabela e inseri os dados iniciais. 
Depois, acrescentei os itens da venda 3017 e conferi se os registros estavam corretos.

Em seguida, fiz 11 consultas para analisar os dados. 
Com elas, consegui identificar os produtos cadastrados, 
encontrar produtos dentro de determinada faixa de preço, 
localizar produtos que começam com “Batata” e verificar quais vendas tiveram entrega.

Também analisei o valor total de cada venda, 
o faturamento por dia, 
o desempenho de cada produto e os resultados por categoria e unidade. 
Além disso, verifiquei quais bairros tiveram entregas com faturamento acima de R$ 40,00.

Por fim, 
fiz uma consulta para verificar diferenças causadas pelo arredondamento dos valores dos itens. 
Assim, consegui entender melhor como os dados das vendas estão organizados e como o SQL pode ser usado para 
gerar informações e análises a partir deles.*/